...
def design1():                  #2 engine tiltrotor, 
    ...
    return UAV(rotors, wings, container(5000, (-2.5,0,1.25), 1.2), fueltanks)
...
def design1_2():                  #2 engine tiltrotor, 
    ...
    return UAV(rotors, wings, container(000, (-4,0,1.25), 1.2), fueltanks)
...
def design2():
    ...
    return UAV(rotors, wings, container(5000, (-8.5,0,1.25),1.2), fueltanks,95000)

class UAV(object):              #rotors(engine), wings(airfoil), container, fueltanks
    def __init__(self, rotors, wings, container, fueltanks, MTOW = 120000.):
